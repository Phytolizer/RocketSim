 ...
 */
public class Graphics implements Runnable, WindowListener, WindowFocusListener, KeyListener {
	...
	public Graphics(ThreadManager threadManager) {
	...
	public Graphics(ThreadManager threadManager, String title) {
	...
	public void setVisible(boolean visible) {
		...
		if(visible) {
			imgBuffer = frame.createImage(width, height);
			threadManager.startThread(this);
		}
